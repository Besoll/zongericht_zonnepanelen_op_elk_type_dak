...
const CtaButton003 = dynamic(() => import('@/components/home/DaktypesSectioned/CtaButtons/CtaButton003'))



const Section1 = () => {
  return (
    <Link href="/parabooldak" className='w-full h-auto flex justify-center items-center text-white
                    smSP:bg-[url("/lp/003/1-1-small.webp")] 
                    mdSP:bg-[url("/lp/003/1-1.webp")] 
                    lgSP:bg-[url("/lp/003/1-1-big.webp")] bg-no-repeat bg-cover bg-center rounded-2xl
