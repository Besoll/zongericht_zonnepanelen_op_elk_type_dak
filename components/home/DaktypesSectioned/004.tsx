...
const CtaButton004 = dynamic(() => import('@/components/home/DaktypesSectioned/CtaButtons/CtaButton004'))



const Section1 = () => {
  return (
    <Link href="/zinken-dak" className='w-full h-auto flex justify-center items-center text-white
                    smSP:bg-[url("/lp/004/1-small.webp")] 
                    mdSP:bg-[url("/lp/004/1.webp")] 
                    lgSP:bg-[url("/lp/004/1-big.webp")] bg-no-repeat bg-cover bg-center rounded-2xl
