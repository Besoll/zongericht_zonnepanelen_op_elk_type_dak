...
return (
  <div className='flex w-full justify-center items-center flex-col md:flex-row max-w-[1200px] gap-3 mb-4 md:mb-12'>
      ...
      <div className='w-full flex flex-col justify-end items-end gap-2'>
          <div className='flex flex-col items-end mt-6 mb-2 justify-end'>
