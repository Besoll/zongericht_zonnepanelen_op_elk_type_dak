...
const CtaButton = dynamic(() => import('@/components/__lp/009/ctaButtons/CtaButton4'))
  ...
  return (
    <div className='w-[95%] max-w-[1440px] flex justify-center items-center flex-col rounded-none gap-8 px-16 md:px-20'>
        ...
        <div className='w-full h-auto flex flex-col justify-center items-center gap-4'>
          <p className='w-full max-w-3/4 text-3xl md:text-4xl font-semibold text-white text-center'>
            Wilt u ook zonnepanelen op uw schuin bitumen dak?        
          </p>
