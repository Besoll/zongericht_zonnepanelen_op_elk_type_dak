  ...
  return (
    <div className="font-sans text-lg w-full">
      ...
      >
        ...
        <input type="hidden" name="SingleLine5" value="https://zonnepanelen.zongericht.nl/dakpannen" />
        <input type="hidden" name="SingleLine6" value="Next.JS LP-010 - New technology" />
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center w-full gap-1 md:gap-2 text-black">
          {/* Text Inputs */}
          <div className='flex flex-col lg:flex-row items-center justify-center w-full gap-1 md:gap-2'>
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        type="text"
                        name="SingleLine"
                        ...
                        className={`file-input bg-qoqu_Light_Blue/10 rounded-xl w-full border-none px-4 mb-2 mt-2 ${formErrors.SingleLine ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-qoqu_Light_Blue/10 rounded-xl w-full border-none px-4 mb-2 mt-2 ${formErrors.PhoneNumber_countrycode ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                ...
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-qoqu_Light_Blue/10 rounded-xl w-full border-none px-4 mb-2 mt-2 ${formErrors.Email ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                        placeholder="Email"
                        disabled={isSubmitted}
                    />
            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-qoqu_Light_Blue/10 rounded-xl w-full border-none px-4 mb-2 mt-2 ${formErrors.SingleLine1 ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                ...
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-qoqu_Light_Blue/10 rounded-xl w-full border-none px-4 mb-2 mt-2 ${formErrors.SingleLine2 ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
          ...
          <button
            ...
            className={`submit-button mt-5 md:mt-0 py-4 md:py-[0.85rem] px-3 md:px-3 md:min-w-[250px] w-full md:w-[250px] rounded-xl  leading-tight border-none text-2xl font-semibold ${isFormValid && !isSubmitted ? 'bg-orange hover:bg-brand_original_main3' : 'bg-qoqu_Light_Blue/90 hover:bg-qoqu_Light_Blue cursor-not-allowed'} text-white shadow-sm transition-colors duration-300`}
          >
            {isSubmitted ?
              "Uw aanvraag is succesvol ingediend" : "Vraag aan" }
          </button>
        </div>
      </form>
    </div>
