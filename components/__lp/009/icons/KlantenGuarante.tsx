...
const IconKlantService = dynamic(() => import('@/components/__lp/008-V1/icons/IconKlantService'))
const IconGuarantee = dynamic(() => import('@/components/__lp/008-V1/icons/IconGuarantee'))

const KlantenGuarante = () => {
  return (
    <div className='flex flex-row gap-2 justify-center items-center my-2 md:my-4 text-left
                     p-4 rounded-lg text-qoqu_Grey'>
