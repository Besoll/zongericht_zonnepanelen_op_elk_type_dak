...
const Section2 = () => {
  ...
  return (
    <div className='w-full flex flex-col justify-center items-center max-w-[1440px] gap-4 px-4'>
        ...
        <div role="tablist" className="w-full tabs flex justify-center items-center gap-1 pb-1 md:pb-8">
            ...
            <input
                ...
                role="tab"
                id="tab1"
                className={`w-full md:w-fit tab px-2 md:px-12 md:py-4 md:pb-11 text-md md:text-xl lg:text-2xl ${activeTab === 1 ? 'bg-qoqu_Orange text-white' : 'hover:bg-qoqu_Orange/20 hover:scale-105 bg-qoqu_Orange/10 text-black/80'}
            ...
            <input
                ...
                role="tab"
                id="tab2"
                className={`w-full md:w-fit tab md:px-12 md:py-4 md:pb-11 text-md md:text-xl lg:text-2xl ${activeTab === 2 ? 'bg-qoqu_Orange text-white' : 'hover:bg-qoqu_Orange/20 hover:scale-105 bg-qoqu_Orange/10 text-black/80'}
                transition duration-300 ease-in-out cursor-pointer
                `}
            ...
            <input
                ...
                role="tab"
                id="tab3"
                className={`w-full md:w-fit tab md:px-12 md:py-4 md:pb-11 text-md md:text-xl lg:text-2xl ${activeTab === 3 ? 'bg-qoqu_Orange text-white' : 'hover:bg-qoqu_Orange/20 hover:scale-105 bg-qoqu_Orange/10 text-black/80'}
                transition duration-300 ease-in-out cursor-pointer 
                `}
                aria-label="Betaling"
                checked={activeTab === 3}
        ...
        <div role="tabpanel" className={`tab-content ${activeTab === 1 ? 'flex opacity-100' : 'hidden opacity-0'} transition duration-300 ease-in-out cursor-pointer`}>
             <div className='w-full h-auto flex flex-col-reverse md:flex-row justify-center items-center px-4 py-4 gap-4 md:gap-6'>
                ...
                <Image 
                    ...
                    alt='glas glas zonnepanelen op  leistenen dak 2'
                    width={400}
                    height={600}
        ...
        <div role="tabpanel" className={`tab-content ${activeTab === 2 ? 'flex opacity-100' : 'hidden opacity-0'} transition duration-300 ease-in-out cursor-pointer`}>
             <div className='w-full h-auto flex flex-col-reverse md:flex-row justify-center items-center px-4 py-4 gap-4 md:gap-6'>
                <div className='w-full h-auto flex flex-col justify-center md:justify-start items-center md:items-start gap-0 md:gap-8'>
                    <p className='text-base font-normal pb-8 md:pb-4'>
        ...
        <div role="tabpanel" className={`tab-content ${activeTab === 3 ? 'flex opacity-100' : 'hidden opacity-0'} transition duration-300 ease-in-out cursor-pointer`}>
             <div className='w-full h-auto flex flex-col-reverse md:flex-row justify-center items-center px-4 py-4 gap-4 md:gap-6'>
                <div className='w-full h-auto flex flex-col justify-center md:justify-start items-center md:items-start gap-0 md:gap-8'>
                    <p className='text-base font-normal pb-8 md:pb-4'>
