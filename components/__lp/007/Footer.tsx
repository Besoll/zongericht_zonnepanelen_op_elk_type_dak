...
const KlantenGuaranteFooter = dynamic(() => import('@/components/__lp/007/icons/KlantenGuaranteFooter'))


const Footer = () => {
  return (
    <footer className="bg-qoqu_Night_Blue shadow-lg text-gray-200 text-base capitalize mt-20 md:mt-5">
