    ...
    return (
      <div className='w-full h-auto flex flex-col gap-6 md:gap-12 pb-8 md:pb-16'>
        ...
        <div className='w-full flex flex-row-reverse justify-center items-center gap-4 mt-4 md:-mt-6'>
          <div className='swiper-button-next-big bg-qoqu_Light_Green rounded-full pl-3 pr-5 py-6 text-center shadow-md md:hover:scale-110 hover:shadow-2xl transition duration-300 ease-in-out md:cursor-pointer'>
            <SwiperButtonNext />
          </div>
          <div className='swiper-button-prev-big bg-qoqu_Light_Green rounded-full pl-3 pr-5 py-6 text-ceter shadow-md md:hover:scale-110 hover:shadow-2xl transition duration-300 ease-in-out md:cursor-pointer'>
            <SwiperButtonPrev />
          </div>
        </div>
