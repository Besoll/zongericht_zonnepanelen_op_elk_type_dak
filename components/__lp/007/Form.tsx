  ...
  return (
    <div className="font-sans text-lg w-full">
      ...
      >
        ...
        <input type="hidden" name="SingleLine5" value="https://zonnepanelen.zongericht.nl/stalen-dak" />
        <input type="hidden" name="SingleLine6" value="Next.JS LP-007 - New technology - Stalen Dak" />
        ...
        <div className="flex flex-col items-center justify-center w-full gap-1 md:gap-2 text-black">
            ...
            <div className='flex flex-col items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        className={`file-input bg-white rounded-[0] w-full border-none px-4 mb-2 mt-2 py-4 md:py-8 ${formErrors.SingleLine ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-8'>
                <div className='flex flex-col items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-white rounded-[0] w-full border-none px-4 mb-2 mt-2 py-4 md:py-8 ${formErrors.PhoneNumber_countrycode ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                ...
                <div className='flex flex-col items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-white rounded-[0] w-full border-none px-4 mb-2 mt-2 py-4 md:py-8 ${formErrors.Email ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                        placeholder="Email"
                        disabled={isSubmitted}
                    />
            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-8'>
                <div className='flex flex-col items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-white rounded-[0] w-full border-none px-4 mb-2 mt-2 py-4 md:py-8 ${formErrors.SingleLine1 ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                ...
                <div className='flex flex-col items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-white rounded-[0] w-full border-none px-4 mb-2 mt-2 py-4 md:py-8 ${formErrors.SingleLine2 ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
          ...
          <button
            ...
            className={`submit-button mt-4 py-5 px-3 md:min-w-[250px] w-full rounded-[0]  leading-tight border-none ${isFormValid && !isSubmitted ? 'bg-qoqu_Night_Blue hover:bg-qoqu_Night_Blue/90' : 'bg-qoqu_Night_Blue/80 cursor-not-allowed'} text-white font-bold text-xl transition-colors duration-300`}
          >
            {isSubmitted ?
