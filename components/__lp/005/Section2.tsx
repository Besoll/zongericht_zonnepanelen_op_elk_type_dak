...
const Section2Part1 = dynamic(() => import("@/components/__lp/005/Section2Part1"))
const Section2Part2 = dynamic(() => import("@/components/__lp/005/Section2Part2"))
const Section2Part3 = dynamic(() => import("@/components/__lp/005/Section2Part3"))
