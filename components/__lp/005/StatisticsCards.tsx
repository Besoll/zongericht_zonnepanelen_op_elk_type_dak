...
const CtaButton6 = dynamic(() => import('@/components/__lp/004/ctaButtons/CtaButton6'))
const Icon1satisfiedHomeowners = dynamic(() => import('@/components/__lp/004/icons/Icon1satisfiedHomeowners'))
const Icon2yarsOfExperiance = dynamic(() => import('@/components/__lp/004/icons/Icon2yarsOfExperiance'))
const Icon3successfullInstalation = dynamic(() => import('@/components/__lp/004/icons/Icon3successfullInstalation'))
const Icon4companiesServed = dynamic(() => import('@/components/__lp/004/icons/Icon4companiesServed'))
...
const StatisticsCards = () => {
  return (
    ...
    px-4 md:px-8 py-4 md:py-8 gap-4 md:gap-6'>


        <div className='w-full flex flex-row justify-center items-center gap-6'>
            <div className='w-full max-w-[380px] min-h-[280px] h-auto flex flex-col justify-start items-center 
