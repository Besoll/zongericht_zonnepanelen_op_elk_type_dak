...
const CtaButton = dynamic(() => import('@/components/__lp/007/ctaButtons/CtaButton1'))
...
const Navbar = () => {
  ...
  return (
    <div className="flex mx-auto justify-center items-center bg-transparent w-full h-20  shadow-lg z-10">
      <div className="flex justify-between items-center w-full px-4 text-primary max-w-[1440px] z-10 gap-4">
