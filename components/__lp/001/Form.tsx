  ...
  return (
    <div className="font-sans text-lg w-full">
      ...
      >
        ...
        <input type="hidden" name="SingleLine5" value="https://zonnepanelen.zongericht.nl/schuin-pvc-dak" />
        <input type="hidden" name="SingleLine6" value="Next.JS LP-001 - New technology" />
            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        className={`file-input bg-qoqu_Blue/10 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.SingleLine ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-qoqu_Blue/10 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.PhoneNumber_countrycode ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                ...
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-qoqu_Blue/10 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.Email ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                        placeholder="Email"
                        disabled={isSubmitted}
                    />
            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-qoqu_Blue/10 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.SingleLine1 ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                ...
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-qoqu_Blue/10 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.SingleLine2 ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
