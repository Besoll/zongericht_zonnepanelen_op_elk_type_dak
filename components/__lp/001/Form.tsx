            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        className={`file-input bg-gray-100 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.SingleLine ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-gray-100 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.PhoneNumber_countrycode ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                ...
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-gray-100 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.Email ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                        placeholder="Email"
                        disabled={isSubmitted}
                    />
            ...
            <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-gray-100 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.SingleLine1 ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
                ...
                <div className='flex flex-col md:flex-row items-center justify-center w-full gap-1 md:gap-2'>
                    <input
                        ...
                        onChange={handleChange}
                        className={`file-input bg-gray-100 rounded-3xl w-full border-none px-4 mb-2 mt-2 ${formErrors.SingleLine2 ? 'border-red-500' : 'file-input-bordered file-input-success relative'}`}
