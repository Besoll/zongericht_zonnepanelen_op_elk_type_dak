    ...
    return (
      <>
        ...
        >
          ...
          <SwiperSlide key={index} className='w-full min-h-[600px] xxs:min-h-[540px] xs:min-h-[500px] md:min-h-[350px] bg-white px-6 py-6 rounded-xl shadow-sm duration-300 ease-in-out md:cursor-pointer gap-8'>
            <div className='w-full h-auto min-h-[600px] xxs:min-h-[540px] xs:min-h-[500px] md:min-h-[300px] flex flex-col-reverse md:flex-col justify-center md:justify-between items-center text-center py-4 gap-4 md:gap-1'>
              ...
              <div className='w-full flex flex-col-reverse md:flex-row gap-4'>
                <hr></hr>
                <div className='w-full flex flex-col-reverse md:flex-row md:justify-between justify-center items-center gap-4 md:gap-1'>
                  <div className='flex flex-col md:flex-row justify-center items-center md:items-start gap-4'>
                    ...
                    <div className='w-full h-auto flex flex-col justify-center items-center md:items-start gap-1 md:gap-4'>
        ...
        <div className='w-full flex flex-row-reverse justify-center items-center gap-4'>
          <div className='swiper-button-next-small rounded-full shadow-md md:hover:scale-110 hover:shadow-2xl transition duration-300 ease-in-out md:cursor-pointer'>
            <SwiperButtonNext />
          </div>
          <div className='swiper-button-prev-small rounded-full shadow-md md:hover:scale-110 hover:shadow-2xl transition duration-300 ease-in-out md:cursor-pointer'>
            <SwiperButtonPrev />
          </div>
        </div>
